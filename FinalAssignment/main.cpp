...
void sound3()
{
    ...
    PlaySound("midday.wav", NULL, SND_ASYNC|SND_FILENAME|SND_LOOP);
...
int i;//sun
	...
	int i1;//sun
    GLfloat a111=-.8f; GLfloat b111=.86f; GLfloat radius111 =.06f;
	...
	glColor3b(0, 0, 0);
		...
		for(i1 = 0; i1 <= triangleAmount;i1++) {
			glVertex2f(
		            a111+ (radius111 * cos(i1 *  twicePi111 / triangleAmount111)),
			    b111+ (radius111 * sin(i1 * twicePi111 / triangleAmount111))
			);
		}
	glEnd();
